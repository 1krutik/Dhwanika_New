    ...
    <div className="bg-gray-50 py-12 px-4">
      <div className="max-w-5xl mx-auto bg-white shadow-md rounded-lg p-6 md:p-10">
        ...
        <p className="text-gray-700">
          Welcome to <strong>Dhwanika Overseas</strong>. By accessing or using
        ...
        <ul className="list-disc pl-6 text-gray-700 space-y-2">
          <li>
            Provide accurate and complete information during inquiries or
            applications.
          </li>
          <li>Ensure all submitted documents are valid and genuine.</li>
          <li>
            Follow the guidelines and requirements provided by embassies and
            authorities.
          </li>
        </ul>
        <hr className="my-6 border-gray-300" />
        ...
        <p className="text-gray-700 mt-2">
          <strong>Dhwanika Overseas</strong>
          <br />
          Email:{" "}
          <a
        ...
        <hr className="my-6 border-gray-300" />
        <h2 className="text-xl font-semibold mb-2">9. Declaration</h2>
        <p className="text-gray-700 mt-2">
          By submitting my details, I override my NDNC registration and
          authorize Dhwanika Oversaes and its representatives to contact me
          through Bulk SMS, RCS SMS & Verified SMS. I further consent to share
          my information on a confidential basis with third parties for
        ...
        <p className="text-gray-700 mt-2">
          ...
          services, and send you marketing communications (with your consent)
          via different channels, including but not limited to SMS, Email, RCS,
          WhatsApp, and Voice.{" "}
        </p>
        <hr className="my-6 border-gray-300" />
